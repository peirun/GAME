package com.yupeirun.controle.partie;
...
import com.yupeirun.controle.joueur.IAFacile;
import com.yupeirun.controle.joueur.Joueur;
import com.yupeirun.controle.joueur.JoueurPhysique;
import com.yupeirun.controle.joueur.JoueurVirtual;
...
//		j.setDivinite(CartesDivinite.getInstance().returnDivinite());
		...
		for (int i = 0; i < (n-1); i++) {
			this.addJoueurs();
			System.out.println("dernier joueur ajoute : " + (i + 1));
		}
